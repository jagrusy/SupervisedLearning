...
def getCreditCardData(path, test_size=0.2, train_size=0.8):
...
if __name__ == "__main__":
    X_train1, X_test1, y_train1, y_test1 = getCreditCardData(path='./Data/ccdefault.xls', test_size=0.2)
    X_train2, X_test2, y_train2, y_test2 = getWineData(path='./Data/winequality-white.csv', test_size=0.2)
